...
const testimonialData = [
  ...
  const Testimonials = () => {
    ...
    const prevTestimonial = () => {
      setCurrentTestimonial((currentTestimonial - 1 + testimonialData.length) % testimonialData.length);
      setSlideDirection("left");
    };
  
    const testimonial = testimonialData[currentTestimonial];
    const testimonialClassName = slideDirection === "right" ? "slide-in-right" : "slide-in-left";
    ...
    return (
      <section className="bg-blue">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">  
          ...
          <svg className="h-12 mx-auto mb-3 text-pink text-pink-400" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <figcaption className="flex items-center justify-center mt-6 space-x-3">
              <img className="w-6 h-6 mb-0 rounded-full" src={testimonial.image} alt={testimonial.name}/>
              <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                <div className="pr-3 text-pink font-medium text-pink-900">{testimonial.name}</div>
          ...
          <div className="flex justify-center items-center max-w-screen-md mx-auto">
            ...
            <button className="arrow-button arrow-button-progress p-2" onClick={nextTestimonial}>
