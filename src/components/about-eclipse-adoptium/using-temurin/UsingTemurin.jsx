...
const UsingTemurin = () => {
  ...
  return (
    <>
      <section className="py-16 max-w-[1048px] w-full mx-auto lg:flex justify-center items-center lg:justify-between xl:px-0 px-6 ">
        ...
        <div className="w-full lg:hidden block mt-10">
          {LatestReleasesCard.map((card, more) => (
            <div key={more} className="w-full ">
              <p className="p-4 rounded-2xl w-full !mb-4 bg-tones-white gap-y-4 text-base font-normal leading-6 text-white backdrop-blur-12">
                {card.content}
              </p>
            </div>
          ))}
