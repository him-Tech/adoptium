...
const OpenBased = () => {
  ...
  return (
    <div className="bg-purple py-14 sm:py-18 xl:px-0 lg:px-8 px-0 relative">
      <div className="mx-auto pl-6 w-full flex lg:flex-row flex-col items-start lg:items-end justify-center lg:space-x-8 xl:space-x-16 relative overflow-hidden">
