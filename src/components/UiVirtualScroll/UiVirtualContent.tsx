  ...
  return (
    <div className="max-w-[1048px] ui-virtual-wrapper mt-10 relative mx-auto px-4 sm:px-0">
      ...
      {/* {data.map((item: any, index: any) => {
        return (
          <div
            className={`flex opacity-50 items-center justify-between ui-virtual-box-${
              index + 1
            }`}
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione qui
            omnis ea architecto excepturi beatae a ab, maxime aliquid molestiae
            velit accusamus incidunt vero eius in necessitatibus nostrum
            molestias saepe. Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Ratione qui omnis ea architecto excepturi beatae a ab, maxime
            aliquid molestiae velit accusamus incidunt vero eius in
            necessitatibus nostrum molestias saepe. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Ratione qui omnis ea architecto
            excepturi beatae a ab, maxime aliquid molestiae velit accusamus
            incidunt vero eius in necessitatibus nostrum molestias saepe. Lorem
            ipsum dolor sit amet consectetur adipisicing elit. Ratione qui omnis
            ea architecto excepturi beatae a ab, maxime aliquid molestiae velit
            accusamus incidunt vero eius in necessitatibus nostrum molestias
            saepe. Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Ratione qui omnis ea architecto excepturi beatae a ab, maxime
            aliquid molestiae velit accusamus incidunt vero eius in
            necessitatibus nostrum molestias saepe. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Ratione qui omnis ea architecto
            excepturi beatae a ab, maxime aliquid molestiae velit accusamus
            ...
            Ratione qui omnis ea architecto excepturi beatae a ab, maxime
            aliquid molestiae velit accusamus incidunt vero eius in
            necessitatibus nostrum molestias saepe.
          </div>
        )
      })} */}
    </div>
